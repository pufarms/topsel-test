...
import { Loader2, Download, Upload, ChevronLeft, ChevronRight, CheckCircle } from "lucide-react";
...
export default function PartnerOrders() {
  ...
  const { data, isLoading } = useQuery<OrdersResponse>({
    queryKey: ["/api/partner/orders", "orders-tab", queryParams],
    queryFn: async () => {
