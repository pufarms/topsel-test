...
export const members = pgTable("members", {
  ...
  isPostpaid: boolean("is_postpaid").notNull().default(false),
  postpaidNote: text("postpaid_note"),
  postpaidSetBy: varchar("postpaid_set_by"),
...
export const memberFormSchema = z.object({
  ...
  managerEmail: z.string().email("유효한 이메일을 입력해주세요").optional().or(z.literal("")),
